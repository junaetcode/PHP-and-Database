...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE orders set id='" . $_POST['userid'] . "', productname='" . $_POST['productname'] . "', quantity='" . $_POST['quantity'] . "', name ='" . $_POST['name'] . "' , address='" . $_POST['address'] . "', number='" . $_POST['number'] . "',order_date='" . $_POST['order_date'] . "' WHERE id='" . $_POST['userid'] . "'");
...
<div><?php if(isset($message)) { echo $message; } ?>
  ...
  <div class="mincol">
    <div class="col left">
        ...
        <label for="free_time">Name:</label>
        <label for="problrm">address:</label>
        <label for="problrm">number:</label>
        <label for="problrm">order_date:</label>
...
<input type="text" name="order_date" class="txtField" value="<?php echo $row['order_date']; ?>">
