...
<h1>Product List</h1>
 ...
 <a href="formproduct.html" class="btn btn-primary mb-3  ml-5">Add New</a>
...
?>
  ...
  <tr>
    ...
    <td><?php echo $row["selling_price"]; ?></td>
		...
		<td><a class="btn btn-primary btn-sm" href="tableproductupdate.php?id=<?php echo $row["id"]; ?>">Update</a>
    <a class="btn btn-danger btn-sm" href="tableproductdelet.php?id=<?php echo $row["id"]; ?>">Delete</a></td>
