...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE product set id='" . $_POST['userid'] . "', productname='" . $_POST['productname'] . "', category='" . $_POST['category'] . "', quantity ='" . $_POST['quantity'] . "' , supplier_name='" . $_POST['supplier_name'] . "', buying_price='" . $_POST['buying_price'] . "',selling_price='" . $_POST['selling_price'] . "' WHERE id='" . $_POST['userid'] . "'");
...
<div><?php if(isset($message)) { echo $message; } ?>
  ...
  <div class="mincol">
    <div class="col left">
        ...
        <label for="free_time">Product Quantity:</label>
        <label for="problrm">supplier name:</label>
        <label for="problrm">buying price:</label>
        <label for="problrm">selling price:</label>
...
<input type="text" name="supplier_name" class="txtField" value="<?php echo $row['supplier_name']; ?>">
