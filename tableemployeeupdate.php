...
if(count($_POST)>0) {
mysqli_query($conn,"UPDATE employee set id='" . $_POST['userid'] . "', name='" . $_POST['name'] . "', phone='" . $_POST['phone'] . "', email ='" . $_POST['email'] . "' , address='" . $_POST['address'] . "', job='" . $_POST['job'] . "', salary='" . $_POST['salary'] . "',join_date='" . $_POST['join_date'] . "' WHERE id='" . $_POST['userid'] . "'");
...
<div><?php if(isset($message)) { echo $message; } ?>
  ...
  <div class="mincol">
    <div class="col left">
        ...
        <label for="free_time">email:</label>
        <label for="problrm">address:</label>
        <label for="problrm">job:</label>
        <label for="problrm">salary:</label>
        <label for="problrm">join-date:</label>
...
<input type="text" name="salary" class="txtField" value="<?php echo $row['salary']; ?>">
<input type="text" name="join_date" class="txtField" value="<?php echo $row['join_date']; ?>">
